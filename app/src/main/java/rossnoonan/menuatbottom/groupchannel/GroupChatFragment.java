package rossnoonan.menuatbottom.groupchannel;
...
import rossnoonan.menuatbottom.utils.MediaPlayerActivity;
...
public class GroupChatFragment extends Fragment {
                ...
                public void onResult(MessageCollection messageCollection, SendBirdException e) {
                    if (e == null) {
                        if (mMessageCollection == null) {
                            ...
                            mMessageCollection.fetch(MessageCollection.Direction.PREVIOUS, new com.sendbird.syncmanager.handler.CompletionHandler() {
                                @Override
    ...
    public void onResume() {
        ...
        SendBirdSyncManager.setup(getActivity().getApplicationContext(), userId, new com.sendbird.syncmanager.handler.CompletionHandler() {
            @Override
            public void onCompleted(SendBirdException e) {
                if (getActivity() == null) {
                    return;
