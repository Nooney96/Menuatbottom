...
import rossnoonan.menuatbottom.openchannel.OpenChannelActivity;
...
public class SendBirdMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_sendbird);
        ...
        findViewById(R.id.linear_layout_group_channels).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SendBirdMainActivity.this, GroupChannelActivity.class);
        ...
        findViewById(R.id.linear_layout_open_channels).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SendBirdMainActivity.this, OpenChannelActivity.class);
                startActivity(intent);
            }
        });
...
//                    Toast.makeText(SendBirdMainActivity.this, "All push tokens unregistered.", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_main:
                Intent intent = new Intent(SendBirdMainActivity.this, SendBirdSettingsActivity.class);
                startActivity(intent);
                return true;
        }
        return false;
