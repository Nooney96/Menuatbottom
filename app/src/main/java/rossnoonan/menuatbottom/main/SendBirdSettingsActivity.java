...
import rossnoonan.menuatbottom.utils.DateUtils;
...
public class SendBirdSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_sendbird);
        ...
        mLinearLayoutBlockedMembersList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SendBirdSettingsActivity.this, BlockedMembersListActivity.class);
        ...
        if (profileUrl.length() > 0) {
            ImageUtils.displayRoundImageFromUrl(SendBirdSettingsActivity.this, profileUrl, mImageViewProfile);
        }
        ...
        mSwitchNotifications.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, final boolean isChecked) {
                if (isChecked) {
                    PushUtils.registerPushTokenForCurrentUser(SendBirdSettingsActivity.this, new SendBird.RegisterPushTokenWithStatusHandler() {
                        @Override
                    ...
                    PushUtils.unregisterPushTokenForCurrentUser(SendBirdSettingsActivity.this, new SendBird.UnregisterPushTokenHandler() {
                        @Override
    ...
    private void setDoNotDisturbTime(final boolean from, final TextView textView) {
        ...
        new TimePickerDialog(SendBirdSettingsActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showSetProfileOptionsDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SendBirdSettingsActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (requestCode == INTENT_REQUEST_CHOOSE_MEDIA && resultCode == Activity.RESULT_OK) {
            ...
            Hashtable<String, Object> info = FileUtils.getFileInfo(SendBirdSettingsActivity.this, uri);
            if (info != null) {
    ...
    private void updateCurrentUserProfileImage(final File profileImage, final ImageView imageView) {
        ...
        SendBird.updateCurrentUserInfoWithProfileImage(nickname, profileImage, new SendBird.UserInfoUpdateHandler() {
            ...
            public void onUpdated(SendBirdException e) {
                ...
                try {
                    ImageUtils.displayRoundImageFromUrl(SendBirdSettingsActivity.this, Uri.fromFile(profileImage).toString(), imageView);
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            }
